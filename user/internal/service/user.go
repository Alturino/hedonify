...
func (u UserService) Login(
	...
	c, span := internal.Tracer.Start(c, "UserService Login")
	defer span.End()
...
func (svc UserService) Register(
	...
	c, span := internal.Tracer.Start(c, "UserService Register")
	defer span.End()
...
func (svc UserService) FindUserById(
	...
	c, span := internal.Tracer.Start(c, "UserService FindUserById")
	defer span.End()
