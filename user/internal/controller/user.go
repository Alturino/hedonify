...
import (
	...
	"github.com/Alturino/ecommerce/user/internal"
...
func (u UserController) Login(w http.ResponseWriter, r *http.Request) {
	c, span := internal.Tracer.Start(r.Context(), "UserController Login")
	defer span.End()
...
func (u UserController) Register(w http.ResponseWriter, r *http.Request) {
	c, span := internal.Tracer.Start(r.Context(), "UserController Register")
	defer span.End()
...
func (u UserController) FindUserById(w http.ResponseWriter, r *http.Request) {
	c, span := internal.Tracer.Start(r.Context(), "UserController FindUserById")
	defer span.End()
